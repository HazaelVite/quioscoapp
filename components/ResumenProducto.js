  ...
  return (
    <div className='shadow p-5 mb-3 flex gap-10 items-center'>
      ...
      <div>
        <button
          type='button'
          className='bg-sky-700 flex gap-2 items-center px-5 py-2 rounded-md font-bold text-white shadow-md uppercase w-full justify-center'
        ...
        <button
          type='button'
          className='bg-red-700 flex gap-2 items-center px-5 py-2 rounded-md font-bold text-white shadow-md uppercase w-full mt-3 justify-center'
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
